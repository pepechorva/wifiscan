...
void crearWeb(vector<WIFI> &lista)
{
    ...
    arxiu << "<TD> Señal </TD>"<< endl;
    arxiu << "<TD> Encriptación </TD>"<< endl;
    arxiu << "</TR>"<< endl;
    for(unsigned int i = 0; i < lista.size(); i++)
    {
        arxiu << "<TR>"<< endl;
    ...
    arxiu << "<IMG SRC=\"/tmp/wifiscan/accesspoint.png\" WIDTH=500 HEIGHT=500 BORDER=2 VSPACE=3 HSPACE=3 ALT=\"Potencia de las señales\">"<< endl;
